                  ...
                  <div className={styles['calendar-day-content']}>
                    <div className={styles['calendar-card-container']}>
                      ...
                      <div className={styles['calendar-card-text-container']}>
                        <div className={styles['calendar-card-text-hour']}>10:00 AM</div>
                        <div className={styles['calendar-card-text-message']}>Llamar Andrea Echeverri he Llamar Andrea Echeverri Llamar Andrea Echeverri Llamar Andrea Echeverri</div>
                      </div>
                    </div>
