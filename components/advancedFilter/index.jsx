    ...
    <div className={`${styles.filterPopUp} ${show ? styles.active : ''}`}>
      ...
      <div className={styles.wrapperFilter}>
        ...
        <div className={styles.filterGroups}>
          ...
          <div className={styles.filterGroup}>
            <div className={styles.advancedSearch}>
              ...
              <div
                ...
                onClick={() => setShowFilter(true)}></div>
            </div>
          </div>

          <div className={styles.advancedDropdownTop}>
            <div className={styles.advancedDropdownText}>
              TIPO DE OPORTUNIDAD:
            </div>
            <div
            ...
            <div
              ...
              <div className={styles.filterGroup}>
                <label className={styles.advancedLabelFilter}>
                  ...
                  <select
                    ...
                    <option value={'default'}>Proyecto 1</option>
              ...
              <div className={styles.filterGroup}>
                <div className={styles.advancedRangeInput}>
                  <div className={styles.advancedRangeText}>
              ...
              {rangeSliders.map((rangeSlider, i) => (
                <div
                  ...
                  <span
                    className={`${styles.labelText} ${styles.labelTextRange}`}>
                  ...
                  <Range
                    ...
                    max={rangeSlider.max}
                    values={
                      rangeSlider.type === 'price' ? priceValues : stateValues
                    }
                    onChange={(values) => {
          ...
          <div
            className={`${styles.advancedButtonsFilter} flex j-c a-c column`}>
            <Button
